...
export const PROJECTS = [
  {
    ...
    image: project1,
    description: {
      en: "Vid-Tube is a React application that allows users to search for and watch videos from various categories. The application is designed to provide a seamless and enjoyable video watching experience for users.",
  ...
  },
  {
    ...
    image: project2,
    description: {
      en: "React application that extracts and summarizes articles using OpenAI's GPT-4 through RapidAPI. It utilizes Redux for API management, Tailwind CSS for styling, and localStorage for saving the history of searches.",
  ...
  },
  {
    ...
    image: project3,
    description: {
      en: "Website for carsharing service known for its commitment to eco-friendly values and sustainable transportation solutions. This website is designed to showcase services, and provide an easy and efficient platform for users to access carsharing features.",
      de: "Website für einen Carsharing-Dienst, der für sein Engagement für umweltfreundliche Werte und nachhaltige Transportlösungen bekannt ist. Diese Website dient der Präsentation von Diensten und bietet Benutzern eine einfache und effiziente Plattform für den Zugriff auf Carsharing-Funktionen.",
    },
    technologies: ["HTML", "SASS"],
    links: [{ resource: "Live Demo", link: "https://vlad-bakumenko.github.io/carsharing/" }],
  },
];

export const CONTACT = {
  address: { en: "Berlin, Germany", de: "Berlin, Deutschland" },
  email: "bakumenkovladyslav@gmail.com",
};

export const SOCIAL_LINKS = {
  linkedin: "http://www.linkedin.com/in/vladyslav-bakumenko-2b537b308",
  github: "https://github.com/Vlad-Bakumenko",
};
