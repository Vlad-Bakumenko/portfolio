      ...
      <div className="flex flex-wrap lg:items-center">
        <div className="w-full lg:w-1/2">
          <div className="flex flex-col items-center">
            <motion.h1 variants={container(0)} initial="hidden" animate="visible" className="pb-16 text-5xl font-thin tracking-tight lg:mt-16 text-center">
              Vladyslav Bakumenko
            </motion.h1>
            ...
            <motion.p className="my-2 max-w-xl py-6 text-center md:text-start md:text-xl tracking-tighter" variants={container(1)} initial="hidden" animate="visible">
