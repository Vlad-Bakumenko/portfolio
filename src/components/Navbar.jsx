  ...
  return (
    <nav className="mb-20 flex items-center justify-between py-6">
      ...
      <div className="m-2 flex items-center justify-center gap-4 text-3xl">
        <button className={language ? "selected text-xl md:text-2xl":"text-xl md:text-2xl"} onClick={() => setLanguage(true)}>EN</button>
        <button onClick={() => setLanguage(false)} className={!language ? "selected text-xl md:text-2xl":"text-xl md:text-2xl"}>DE</button>
